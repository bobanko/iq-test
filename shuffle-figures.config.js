import { generateShuffleFiguresQuestion } from "./shuffle-figures.generator.js";
...
export const shuffleFiguresConfigs = {
  ...
  figRotLetters: {
    ...
    figureGroups: [["letter-p", "letter-t", "letter-u"]],
    // colors: [...defaultColors],
    // colors: ["blue"],
    rotations: [0, 90, 180],
  ...
  oneFigRectTriangleCircle: {
    ...
    // todo(vmyshko): fix rotation for scaled figures
    rotations: [0, 90, 180],
